...
config_file = os.path.join(mmseg, 'configs/swin/20211128_swinT_i80k_sj0.6.py')
checkpoint_file = os.path.join(mmseg, 'work_dirs/20211128_swinT_i80k_sj0.6/latest.pth')
